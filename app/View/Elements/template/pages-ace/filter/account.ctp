<div class="pull-right">
    <div class="col-xs-12">
        ...
        <a href="<?= Router::url("/account-add", true) ?>" class="btn btn-success btn-cons"><i class="fa fa-plus"></i> <?php echo __("Tambah") ?></a>
    </div>
</div>
    ...
    <div class="padding-40 ">
        ...
        <form class="panel-filter" role="form" action="#">
            ...
            <div class="form-group form-group-default">
                ...
                <input type="text" name="User.username" placeholder="<?= __("") ?>" class="form-control">
            </div>
            <div class="form-group form-group-default">
                <label><?= __("Nama Depan") ?></label>
                <input type="text" name="Biodata.first_name" placeholder="<?= __("") ?>" class="form-control">
            </div>
            <div class="form-group form-group-default">
                <label><?= __("Nama Belakang") ?></label>
                <input type="text" name="Biodata.last_name" placeholder="<?= __("") ?>" class="form-control">
            </div>
            <div class="form-group form-group-default">
                <label><?= __("Alamat") ?></label>
                <input type="text" name="Biodata.address" placeholder="<?= __("") ?>" class="form-control">
            </div>
