<div class="pull-right">
    <div class="col-xs-12">
        ...
        <a href="<?= Router::url("/module-content-add", true) ?>" class="btn btn-success btn-cons"><i class="fa fa-plus"></i> <?php echo __("Tambah") ?></a>
    </div>
</div>
    ...
    <div class="padding-40 ">
        ...
        <form class="panel-filter" role="form" action="#">
            ...
            <div class="form-group form-group-default">
                ...
                <input type="text" name="ModuleContent.name" placeholder="<?= __("") ?>" class="form-control">
            </div>
            <div class="form-group form-group-default">
                <label><?= __("Alias") ?></label>
                <input type="text" name="ModuleContent.alias" placeholder="<?= __("") ?>" class="form-control">
            </div>
            <div class="form-group form-group-default">
