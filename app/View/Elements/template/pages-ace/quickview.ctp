                                    ...
                                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                                        <span class="col-xs-height col-middle">
                                            <span class="thumbnail-wrapper d32 circular bg-success">
                                                <img width="34" height="34" alt="" data-src-retina="<?php echo Router::url("/template/pages-ace/assets/img/profiles/1x.jpg", true) ?>" data-src="<?php echo Router::url("/template/pages-ace/assets/img/profiles/1x.jpg", true) ?>" src="<?php echo Router::url("/template/pages-ace/assets/img/profiles/1x.jpg", true) ?>" class="col-top">
                                            </span>
                                        </span>
                            ...
                            <ul>
                                ...
                                <li class="chat-user-list clearfix">
                                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                                        <span class="col-xs-height col-middle">
                                            <span class="thumbnail-wrapper d32 circular bg-success">
                                                <img width="34" height="34" alt="" data-src-retina="<?php echo Router::url("/template/pages-ace/assets/img/profiles/2x.jpg", true) ?>" data-src="<?php echo Router::url("/template/pages-ace/assets/img/profiles/2.jpgs", true) ?>" src="<?php echo Router::url("/template/pages-ace/assets/img/profiles/2x.jpg", true) ?>" class="col-top">
                                            </span>
                                        </span>
                                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
                                ...
                                <li class="chat-user-list clearfix">
                                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                                        <span class="col-xs-height col-middle">
                                            <span class="thumbnail-wrapper d32 circular bg-success">
                                                <img width="34" height="34" alt="" data-src-retina="<?php echo Router::url("/template/pages-ace/assets/img/profiles/3x.jpg", true) ?>" data-src="<?php echo Router::url("/template/pages-ace/assets/img/profiles/3x.jpg", true) ?>" src="<?php echo Router::url("/template/pages-ace/assets/img/profiles/3x.jpg", true) ?>" class="col-top">
                                            </span>
                                        </span>
                                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
                    ...
                    <div class="chat-inner" id="my-conversation">
                        ...
                        <div class="message clearfix">
                            <div class="profile-img-wrapper m-t-5 inline">
                                <img class="col-top" width="30" height="30" src="<?php echo Router::url("/template/pages-ace/assets/img/profiles/avatar_small.jpg", true) ?>" alt="" data-src="<?php echo Router::url("/template/pages-ace/assets/img/profiles/avatar_small.jpg", true) ?>" data-src-retina="<?php echo Router::url("/template/pages-ace/assets/img/profiles/avatar_small2x.jpg", true) ?>">
                            </div>
