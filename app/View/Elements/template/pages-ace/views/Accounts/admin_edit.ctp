<?php echo $this->Form->create("Account", array("class" => "", "action" => "edit", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="form-group form-group-default">
            ...
            echo $this->Form->input("User.username", array("div" => false, "label" => false, "class" => "form-control", "disabled" => true));
            ?>
        </div>
        <div class="form-group form-group-default">
            <?php
            echo $this->Form->label("User.email", __("Email"), array("class" => "col-sm-2 control-label"));
            echo $this->Form->input("User.email", array("div" => false, "label" => false, "class" => "form-control", "disabled" => true));
            ?>
        </div>
    </div>
</div>
