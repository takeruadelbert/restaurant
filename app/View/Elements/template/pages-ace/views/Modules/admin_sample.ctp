<?php echo $this->Form->create("Module", array("class" => "", "action" => "add", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            <?php
            echo $this->Form->input("desc", array("div" => false, "label" => false, "class" => "form-control ckeditor-fix"));
            ?>
        </div>
    </div>
</div>
