<?php echo $this->Form->create("CompanyProfile", array("class" => "", "action" => "edit", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="form-group form-group-default">
            ...
            echo $this->Form->input("CompanyProfile.phone", array("empty" => "- Tidak ada pajak -", "div" => false, "label" => false, "class" => "form-control"));
            ?>
        </div>
        <div class="form-group form-group-default">
            <?php
