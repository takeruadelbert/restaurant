<form action="#" role="form" class="form-horizontal panel-filter">
    <div class="panel panel-info">
        <div class="panel-heading">
            ...
            <a href="<?= Router::url("/admin/user_groups/add", true) ?>" class="pull-right btn btn-xs btn-default"><i class="icon-plus-circle2"></i><?= __("Tambah") ?></a>
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="UserGroup.name" placeholder="<?= __("") ?>" class="form-control input-sm">
                        </div>
                    </div>
                </div>
            </div>
