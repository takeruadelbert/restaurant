<form action="#" role="form" class="form-horizontal panel-filter">
    <div class="panel panel-info">
        <div class="panel-heading">
            ...
            <a href="<?= Router::url("/admin/module_contents/add", true) ?>" class="pull-right btn btn-xs btn-default"><i class="icon-plus-circle2"></i><?= __("Tambah") ?></a>
        </div>
        <div class="panel-body toggle-target" style="display:none" data-toggle-id="filter">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="col-md-4 control-label"><?= __("Label") ?></label>
                        <div class="col-md-8">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <?= $this->Form->input(null, ['label' => false, "div" => false, 'options' => $modules, "name" => "ModuleContent.module_id", "class" => "form-control input-sm","empty"=>"-"]) ?>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="col-md-4 control-label"><?= __("Parent") ?></label>
                        <div class="col-md-8">
                            <?= $this->Form->input(null, ['label' => false, "div" => false, 'options' => $moduleContents, "name" => "ModuleContent.parent_id", "class" => "form-control input-sm","empty"=>"-"]) ?>
                        </div>
                    </div>
                </div>
