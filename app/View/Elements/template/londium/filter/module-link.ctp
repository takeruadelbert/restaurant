<form action="#" role="form" class="form-horizontal panel-filter">
    <div class="panel panel-info">
        <div class="panel-heading">
            ...
            <a href="<?= Router::url("/admin/module_links/add", true) ?>" class="pull-right btn btn-xs btn-default"><i class="icon-plus-circle2"></i><?= __("Tambah") ?></a>
        </div>
        <div class="panel-body toggle-target" style="display:none" data-toggle-id="filter">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="col-md-4 control-label"><?= __("Nama") ?></label>
                        <div class="col-md-8">
                            <input type="text" name="ModuleLink.name" placeholder="<?= __("") ?>" class="form-control input-sm">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="ModuleLink.alias" placeholder="<?= __("") ?>" class="form-control input-sm">
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <?= $this->Form->input(null, ['label' => false, "div" => false, 'options' => $modules, "name" => "ModuleLink.module_id","class"=>"form-control input-sm","empty"=>"-"]) ?>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="col-md-4 control-label"><?= __("Konten Modul") ?></label>
                        <div class="col-md-8">
                            <?= $this->Form->input(null, ['label' => false, "div" => false, 'options' => $moduleContents, "name" => "ModuleLink.module_content_id","class"=>"form-control input-sm","empty"=>"-"]) ?>
                        </div>
                    </div>
                </div>
            </div>
