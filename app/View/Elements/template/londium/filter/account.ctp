<form action="#" role="form" class="form-horizontal panel-filter">
    <div class="panel panel-info">
        <div class="panel-heading">
            ...
            <a href="<?= Router::url("/admin/accounts/add", true) ?>" class="pull-right btn btn-xs btn-default"><i class="icon-plus-circle2"></i><?= __("Tambah") ?></a>
        </div>
        <div class="panel-body toggle-target" style="display:none" data-toggle-id="filter">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="col-md-4 control-label"><?= __("Nama Akun") ?></label>
                        <div class="col-md-8">
                            <input type="text" name="User.username" placeholder="<?= __("") ?>" class="form-control input-sm">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="col-md-4 control-label"><?= __("Nama Depan") ?></label>
                        <div class="col-md-8">
                            <input type="text" name="Biodata.first_name" placeholder="<?= __("") ?>" class="form-control input-sm">
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="col-md-4 control-label"><?= __("Nama Belakang") ?></label>
                        <div class="col-md-8">
                            <input type="text" name="Biodata.last_name" placeholder="<?= __("") ?>" class="form-control input-sm">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="col-md-4 control-label"><?= __("Alamat") ?></label>
                        <div class="col-md-8">
                            <input type="text" name="Biodata.address" placeholder="<?= __("") ?>" class="form-control input-sm">
                        </div>
                    </div>
                </div>
            </div>
