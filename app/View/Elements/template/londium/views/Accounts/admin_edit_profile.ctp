<?php echo $this->Form->create("Account", array("class" => "form-horizontal", "action" => "edit_profile", "id" => "formSubmit","type"=>"file", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
    ...
    <div class="panel-body">
        ...
        <div class="row">       
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <?php
                    echo $this->Form->label("profile_picture", __("Foto"), array("class" => "col-sm-4 control-label"));
                    echo $this->Form->input("profile_picture", array("div" => array("class" => "col-sm-6"), "label" => false, "class" => "form-control","type"=>"file"));
                    ?>
                </div>
            </div>
        </div>
