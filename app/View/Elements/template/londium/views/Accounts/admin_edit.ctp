<?php echo $this->Form->create("Account", array("class" => "form-horizontal", "action" => "edit", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    echo $this->Form->input("User.username", array("div" => array("class" => "col-sm-6"), "label" => false, "class" => "form-control", "disabled" => true));
                    ?>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    echo $this->Form->input("User.email", array("div" => array("class" => "col-sm-6"), "label" => false, "class" => "form-control", "disabled" => true));
                    ?>
                </div>
            </div>
        </div>
...
<div class="panel panel-default">
    ...
    <?php
    echo $this->Form->hidden("Biodata.id");
    ?>
    <div class="panel-body">
        <div class="row">       
            <div class="col-md-6">
