<?php
echo $this->element(_TEMPLATE_DIR . "/{$template}/filter/device");
?>
<div class="panel panel-default">
    <div class="panel-body">
        <div class="block-inner text-danger">
            <h6 class="heading-hr"><?= __("DATA DEVICE") ?>
                        ...
                        if (empty($data['rows'])) {
                            ...
                            foreach ($data['rows'] as $item) {
                                ...
                                <tr id="row-<?= $i ?>" class="removeRow<?php echo $item[Inflector::classify($this->params['controller'])]['id']; ?>">
                                    ...
                                    <td class="text-center"><?= $item['Device']['name'] ?></td>
                                    <td class="text-center"><?= $item['Device']['ip_address'] ?></td>
