<?php echo $this->Form->create("MenuCategory", array("class" => "form-horizontal form-separate", "action" => "edit", "type" => "file", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="block-inner text-danger">
                    <h6 class="heading-hr"><?= __("Ubah Kategori") ?>
                    </h6>
                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-sm-9 col-md-8">
                                                <input type="file" class="form-control styled" name="data[MenuCategory][gambar]">
                                                <?php
                                                if (!empty($this->data['MenuCategory']['image_path'])) {
                                                    ?>
                                                    <img src="<?= Router::url($this->data['MenuCategory']['image_path'], true) ?>" width="200" height="100" style="padding-top: 10px;">
                                                    <?php
                                                }
                                                ?>
                                            </div>
