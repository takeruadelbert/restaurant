                ...
                <table width="100%" class="table table-hover table-bordered">
                    ...
                    <tbody>
                        ...
                        if (empty($data['rows'])) {
                            ...
                            <td><?= emptyToStrip(@$item['Biodata']['Gender']['name']) ?></td>
                            <td><?= $this->Sidispop->tempatLahir($item['Biodata']) ?></td>
                            <td><?= $this->Html->cvtHariTanggal($item['Biodata']['tanggal_lahir'], false) ?></td>
                            <td><?= emptyToStrip(@$item['Biodata']['Religion']['name']) ?></td>
                            <td><?= emptyToStrip(@$item['Employee']['EmployeeClass']['name']) ?></td>
