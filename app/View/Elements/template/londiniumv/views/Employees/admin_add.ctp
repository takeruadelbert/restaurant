                ...
                <div class="panel-body">
                    ...
                    <div>
                        <div class="form-group">
                            ...
                            ?>
                            <?php
                            echo $this->Form->label("Account.User.password", __("Password"), array("class" => "col-md-2 control-label"));
                            echo $this->Form->input("Account.User.password", array("div" => array("class" => "col-md-4"), "label" => false, "class" => "form-control", "value" => "sidispop123", "type" => "text", "readonly" => true));
                            echo $this->Form->hidden("Account.User.repeat_password", array("div" => array("class" => "col-md-4"), "label" => false, "class" => "form-control", "value" => "sidispop123", "type" => "text"));
                            ?>
                        </div>
                        <div class="form-group">
                            <?php
