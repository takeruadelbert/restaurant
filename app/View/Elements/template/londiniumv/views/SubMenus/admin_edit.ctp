                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            echo $this->Form->input("SubMenu.parent_id", array("div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "select-full", "empty" => "Tidak Ada", "options" => $parents[$this->data["Menu"]["label"]]));
                                            ?>
                                        </div>
                                    </div>
                                </div>
